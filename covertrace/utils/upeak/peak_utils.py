...
class Peaks(OrderedDict):
    ...
    def add_site(self, name, traces, predictions=None, weights=None, model=None, normalize=False, steps=25, 
        ...
        no_nan_traces = nan_helper_2d(traces) #nans in peaks can interfere with segmentation
    ...
    def filter_peaks(self, length_thres=None, assym_thres=None, linear_thres=None, amp_thres=None, prom_thres=None, height_assym_thres=None):
        '''
        ...
        for key in self.keys():
            clean_labels, clean_seeds = clean_peaks(self[key].traces, self[key].peak_labels, self[key].seed_labels,
                length_thres=length_thres, assym_thres=assym_thres, linear_thres=linear_thres, amp_thres=amp_thres, 
                prom_thres=prom_thres, height_assym_thres=height_assym_thres)
...
class peak_site():
    def __init__(self, traces, peak_labels, seed_labels, predictions=None):
        ...
        self.raw_traces = np.array(traces, copy=True)
